...
import { useFindOneInstructorQuery, useUpdateInstructorMutation } from '../../../store/features/instructors';
...
const InstructorProfile = () => {
    ...
    const { isLoading } = useFindOneInstructorQuery({ id: user.infos.uid });
