import { Button, Card, Col, Divider, Form, Image, Input, Row, Typography } from "antd"
            ...
            <Col span={8}>
                <ContentScroll>
                    <Card>
                        ...
                        <Title style={{ textAlign: 'center', marginTop: 20 }} level={4}>{user.infos.email}</Title>
                        <Paragraph style={{ textAlign: 'center', marginTop: 20 }}>User informations</Paragraph>
                    </Card>
                </ContentScroll>
                ...
                <Row gutter={30}>
                    <Col span={12}>
                        <Button
                            ...
                            type="primary" size="large" block>Mettre à jour</Button>
                    </Col>
                    <Col span={12}>
                        <Button icon={
                            <Icon type="DeleteOutlined" />
                        } ghost danger type="primary" size="large" block>Supprimer mon compte</Button>
                    </Col>
                </Row>
            </Col>
