import { Button, Card, Col, Radio, Row, Space, Typography, Table, Divider } from "antd";
import { FC, useState } from "react";
import { Column, Pie, Line, TinyArea } from '@ant-design/plots';
            ...
            <Row gutter={[10, 10]}>
                ...
                <Col span={24}>
                    ...
                    >
                        <Row gutter={[30, 10]}>
                            <Col span={18}>
                                {contentList[activeColumnTabKey]}
                            </Col>
                            <Col span={6}>
                                ...
                                <div style={{ marginTop: 30 }}>
                                    {
                                        [...new Array(7)].map((_, index) => (
                                            <Row key={index} style={{ marginTop: 15 }} align="middle" justify="space-between">
                                                <Space>
                                                    <Button type={index < 3 ? "primary" : 'text'} shape="circle">{index + 1}</Button>
                                                    <Text>工专路 0 号店</Text>
                                                </Space>
                                                <Text>323,234</Text>
                                            </Row>
