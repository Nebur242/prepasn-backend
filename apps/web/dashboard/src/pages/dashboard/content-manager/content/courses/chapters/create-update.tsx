...
import { Card, FormInstance, Typography, Select, Divider, Form, Col, Row, Input } from 'antd';
...
const CreateUpdate: FC<ICreateAndUpdateProps> = ({
    ...
    const { isLoading: courseLoading, data: course } = useFindOneCourseQuery(courseId as string);
                ...
                <Card>
                    ...
                    >
                        <Select
                            ...
                            allowClear
                        >
                            {course && <Option key={course.id} value={course.id}>
                                {course.title}
                            </Option>}
                        </Select>
                    </Form.Item>
